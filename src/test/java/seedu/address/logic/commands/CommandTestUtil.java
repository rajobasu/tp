...
public class CommandTestUtil {
    ...
    static {
        ...
        DESC_BOB = new EditCustomerDescriptorBuilder().withName(VALID_NAME_BOB).withAddress(VALID_ADDRESS_BOB)
     ...
     * CommandException message matches {@code expectedMessage} <br> - the address book, filtered customer list and
     * selected customer in {@code actualModel} remain unchanged
     */
    ...
    /**
     * Updates {@code model}'s filtered list to show only the customer at the given {@code targetIndex} in the {@code
